        ...
        <div class="login-form">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-x" required/>
                </div>
                <div class="form-group">
                    <label for="password" class="label">Pasword</label><br>
                    <input type="password" class="form-control form-control-x" required/>
                </div>
                <div class="submit-div">
                    <button href="#" class="submit-button">Login</button>
                </div>
            </form>
        </div>
    </div>
